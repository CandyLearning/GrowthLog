...
- [x] 06.1 相關規格已審查 — **簽名**: 2026-05-13 00:00
- [x] 06.2 交付物已審查 — **簽名**: 2026-05-13 00:00

> **本次 scope（2026-05-13 補充循環）**：針對編輯&刪除學習目標的前端實作：
> - MSW handlers：`PATCH /api/v1/goals/{goalId}` 和 `DELETE /api/v1/goals/{goalId}`
> - 學習目標頁面新增編輯表單與刪除確認對話框
>
> *(前次 scope 2026-05-09 已完成：MVP 全功能前端建立)*
...
```bash
cd C:\Users\MSI-I7\Documents\Candy\candy_workspace\GrowthLog/frontend && npm run dev &
```
