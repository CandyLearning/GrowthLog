...
- [x] 04.1 相關規格已審查 — **簽名**: 2026-05-13 00:00
- [x] 04.2 交付物已審查 — **簽名**: 2026-05-13 00:00

> **本次 scope（2026-05-12 補充循環）**：僅針對 2 個新增 endpoint：
> - `PATCH /api/goals/{goal_id}` — 編輯學習目標
> - `DELETE /api/goals/{goal_id}` — 刪除學習目標（cascade）
